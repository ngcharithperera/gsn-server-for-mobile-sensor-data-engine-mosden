 ...
 * 
 */
public class Nexus7Wrapper extends AbstractWrapper {
  ...
  private final transient Logger logger = Logger.getLogger(Nexus7Wrapper.class);
  private int counter;
...
//      packetType = 2;
      ...
      postStreamElement(new Serializable[] { temperature, humidity, o2, pressure });       
    }
  }
