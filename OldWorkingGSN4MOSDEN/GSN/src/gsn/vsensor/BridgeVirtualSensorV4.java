...
public class BridgeVirtualSensorV4 extends AbstractVirtualSensor {

    private static final transient Logger logger = Logger.getLogger(BridgeVirtualSensorV4.class);
    ...
    public void dataAvailable(String inputStreamName, StreamElement data) {
    	...
    	System.out.println(data.getData()[2].toString());
